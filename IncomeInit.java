...
public class IncomeInit {
	public static String IN_FILE_LOCATION = "sampleInput.csv";

	
	public static String OUT_FILE_LOCATION = "sampleOutput.csv";

	// currency code
	public static String CURRENCY_CODE_IND = "INR";
	public static String CURRENCY_CODE_GBP = "GBP";
	public static String CURRENCY_CODE_SGP = "SGP";
	...
	public static String FILE_SIMPLE = " ";
